...
public class BDNaviGuideActivity extends Activity {
    ...
    boolean iswhole = false; // 距离太近不需要导航
...
//        iswhole = true;
            ...
            HomeActivity.activityList.add(this);
            createHandler();
            ...
            if (intent != null) {
                ...
                if (bundle != null) {
                    mBNRoutePlanNode = (BNRoutePlanNode) bundle.getSerializable(HomeActivity.ROUTE_PLAN_NODE);
                }
            }
            //显示自定义图标
            if (hd != null) {
    ...
    protected void onDestroy() {
        ...
        HomeActivity.activityList.remove(this);
